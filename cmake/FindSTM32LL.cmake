IF(NOT GENERATED_CODE)
    MESSAGE(FATAL_ERROR "You must define path to the generated code using GENERATED_CODE variable")
ENDIF()
...
FIND_PATH(STM32LL_INCLUDE_DIRS ${LL_HEADERS}
	PATH_SUFFIXES include stm32${STM32_FAMILY_LOWER}
        HINTS ${GENERATED_CODE}/Drivers/STM32${STM32_FAMILY}xx_HAL_Driver/Inc
...
FOREACH(LL_SRC ${LL_SRCS})
	...
	FIND_FILE(LL_${LL_SRC_CLEAN}_FILE ${LL_SRC}
		PATH_SUFFIXES src stm32${STM32_FAMILY_LOWER}
                HINTS ${GENERATED_CODE}/Drivers/STM32${STM32_FAMILY}xx_HAL_Driver/Src
		ONLY_CMAKE_FIND_ROOT_PATH
	)
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(STM32LL DEFAULT_MSG STM32LL_INCLUDE_DIRS STM32LL_SOURCES)
